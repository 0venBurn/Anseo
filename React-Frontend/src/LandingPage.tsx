...
const LandingPage: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      />
      <div className="absolute top-10 left-1/2 transform -translate-x-1/2 text-5xl font-bold text-orange-600">ANSEO</div>
      ...
      <div className="relative z-10 flex flex-col items-center text-center mt-20">
        <h1 className="text-4xl font-bold mb-4">The place to be.</h1>
      ...
      <div className="relative z-10 flex space-x-4 mt-10">
        <Button 
          variant="contained" 
          color="error" 
          sx={{ backgroundColor: 'red', color: 'white', borderRadius: '50px', padding: '0.5rem 2rem' }}
        ...
        <Button 
          variant="outlined" 
          sx={{ borderColor: 'rgba(255, 255, 255, 0.7)', color: 'black', backgroundColor: 'rgba(255, 255, 255, 0.5)', padding: '0.5rem 2rem', backdropFilter: 'blur(5px)' }}
        >
          About
        </Button>
      </div>
