...
const QuestionPage1: React.FC = () => {
  ...
  const options = [
    { label: "Manhatten", icon: <span>&#36;</span> },
    { label: "Brooklyn", icon: <span>&#128101;</span> },
    { label: "Queens", icon: <span>&#128652;</span> },
    { label: "The Bronx", icon: <span>&#128110;</span> },
    { label: "Staten Island", icon: <span>&#127979;</span> },
    { label: "No Preference", icon: <FavoriteIcon /> },
