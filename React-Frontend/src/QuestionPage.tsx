  ...
  return (
    <div className="relative h-screen bg-blue-400 text-white flex flex-col items-center justify-between">
      ...
      <div className="flex flex-col items-center text-center mt-12">
        <h1 className="text-5xl font-bold mb-10">What is most important for your business?</h1>
        <div className="grid grid-cols-2 gap-4">
          {['Affordability', 'Public Transport', 'High Footfall', 'X', 'Y', 'Z', 'A', 'B', 'C', 'D'].map(option => (
            <button
              key={option}
      ...
      <div className="w-full flex justify-center items-center py-4 border-t border-white mt-10">
        <Button 
            variant="contained" 
            sx={{
                fontSize: '1.25rem',
